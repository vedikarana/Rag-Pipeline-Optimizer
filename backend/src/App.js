...
import { Upload, Play, Download, BarChart3, Trophy, Clock, DollarSign } from 'lucide-react';
...
function App() {
  ...
  const handleEvaluate = async (questions, criteria) => {
    ...
    try {
      ...
      setHistory([resultWithTimestamp, ...history].slice(0, 10)); // Keep last 10
      setStep(4);
    } catch (error) {
